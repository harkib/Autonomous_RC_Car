...
s1a = zeros([2,sensorMax/stepSize]);
s2a = zeros([2,sensorMax/stepSize]);
s3a = zeros([2,sensorMax/stepSize]);
s4a = zeros([2,sensorMax/stepSize]);
s5a = zeros([2,sensorMax/stepSize]);
